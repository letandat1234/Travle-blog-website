...
namespace Travel_Blog.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "commentId,postId,userId,body")] Comment comment)
        {
            ...
            ViewBag.userId = new SelectList(db.Users, "userId", "userId", comment.userId);
            return View(comment);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "commentId,postId,userId,body")] Comment comment)
        {
            if (ModelState.IsValid)
            {
